                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input maxlength="50" name="subject_name" id="name" type="text" class="form-control" required>
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input maxlength="10" name="subject_code" type="text" class="form-control" required>
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea maxlength="255" name="description" id="comments" rows="3" class="form-control"></textarea>
                                                        </div>
                                                    </div>
                                                </div><!--end row-->
