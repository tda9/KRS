                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input  maxlength = "20" name="name" id="name" type="text" class="form-control" required>
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input maxlength = "20" name="type" type="text" class="form-control" required>
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input maxlength="2" max = "99" name="order" type="number" class="form-control" required oninput="enforceMaxLength(event)">
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-6">                       
                                                        ...
                                                        <div  class="mt-2 d-flex justify-content-around">
                                                            <div><label for="html">Activate</label>
                                                                <input type="radio" name="status" value="false"></div>
                                                            <div><label for="html"  >Deactivate</label>
                                                                <input type="radio" name="status" value="true"></div>
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="description" id="comments" rows="3" class="form-control"  maxlength="255" ></textarea>
                                                        </div>
                                                    </div>
                                                </div><!--end row-->
