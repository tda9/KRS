                                ...
                                <div class="col-lg-6">
                                    <div class="rounded bg-white-50 shadow mt-4">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <form action="TrainingServlet" class="mt-4" >
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label class="form-label">Name</label>
                                                            <input maxlength="50" name="subject_name" id="name" type="text" class="form-control" required value="${subjectDetails.getSubject_name()}">
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input maxlength="10" name="subject_code" type="text" class="form-control" required value="${subjectDetails.getSubject_code()}">
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-6">                       
                                                        ...
                                                        <div class="mt-2 d-flex justify-content-around">
                                                            <div><label for="html">Activate</label>
                                                                <input type="radio" name="status" ${subjectDetails.isStatus()==false?"checked":""} value="false"></div>
                                                            <div><label for="html"  >Deactivate</label>
                                                                <input type="radio" name="status" ${subjectDetails.isStatus()==true?"checked":""} value="true"></div>
                                                        </div>
                                                    </div><!--end col-->
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea  maxlength="255" name="description" id="comments" rows="3" class="form-control" value="${subjectDetails.getDescription()}">${subjectDetails.getDescription()}</textarea>
                                                        </div>
                                                    </div>
                                                </div><!--end row-->
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="hidden" name="subject_id" value="${subjectDetails.getSubject_id()}">
                                                    </div><!--end col-->
                                                    ${warn}
                                                </div><!--end row-->
                                            </form><!--end form-->
